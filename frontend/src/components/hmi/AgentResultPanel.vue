...
.attraction-photo { width: 100%; min-height: 120px; border-radius: 6px; overflow: hidden; margin-bottom: 4px; flex-shrink: 0; }
.attraction-photo img { width: 100%; min-height: 120px; object-fit: cover; display: block; }
...
.slot-photo { width: 100%; min-height: 100px; max-height: 160px; object-fit: cover; border-radius: 6px; margin-top: 4px; display: block; }
